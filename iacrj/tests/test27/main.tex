...
city={Goleta}]{University of California, Santa Barbara}
\addaffiliation[country={Elbonia},city={Whereever}]{University of Antartica}
...
%%%% 5. ABSTRACT %%%%
\begin{abstract}
  This mixes encodings with Ð and f\"ur and \th and a comment % but also a comment
and another line and some math \(\frac{1}{2}^2 + \tilde{a}\).

  \lipsum[8]
\end{abstract}
\begin{textabstract}
This is a text abstract with encodings with Ð and f\"ur and \th and a comment % but also a comment                    
and another line and some math \(\frac{1}{2}^2 + \tilde{a}\).
\end{textabstract}
