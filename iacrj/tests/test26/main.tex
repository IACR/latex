...
\addauthor[orcid=0000-0003-1010-8157,inst={1,2},footnote={Work done while working for XYZ.}]{Alice Accomplished}
...
\title[running={Thoughts on binary functions},
  ...
  Thoughts about "binary" functions and \$\ on $GF(p)$ by \niceguy\ at 30°C\thanks{Work done while working at ABC.}}
\begin{document}
