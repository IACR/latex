...
\subtitle{iacrj LaTeX Class Documentation (v0.9.4)}
% We remove the date from the footer on this document.
\documentdate{}
...
\item Avoid using too many packages. Many authors are lazy and just
  ...
  packages either won't work or need to be loaded in a prescribed
  order. There is a list of forbidden packages at \url{https://publish.iacr.org/forbidden}.
...
acceptable license is \texttt{CC-BY-4.0}.  An example would look like:
