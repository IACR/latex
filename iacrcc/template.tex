...
% Note that \addfunding collects metadata for indexing.
% When the text option is used then a Funding Acknowledgements
% Section is autoatically created before the References with this text.
% An example is:
%
