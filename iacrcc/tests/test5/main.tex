...
\addauthor[inst={1},footnote={Thanks to my mom!},email={bad@example.com}]{Bob Badenuff}
\addauthor[inst={3,2,1}]{Tancr{\`e}de Lepoint}

\affiliation[ror=02t274463,country={United States}]{University of California, Santa Barbara}
