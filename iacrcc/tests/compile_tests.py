...
def test11_test():
  ...
  for option in ['-pdflua', '-pdf']:
    with tempfile.TemporaryDirectory() as tmpdirpath:
      ...
      assert len(title) == 2 # two languages: en and default.
      ...
      assert len(rights) == 2 # two languages
      ...
      assert authors == ['Joppe W. Bös', 'Kevin S. McCurley']
