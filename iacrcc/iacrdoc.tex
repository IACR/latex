% IACR Communications in Cryptology Class Documentation
% by Joppe W. Bos and Kevin S. McCurley (2022)
%
...
\begin{verbatim}
\documentclass[⟨options⟩]{iacrcc}
\end{verbatim}
There are several \emph{optional} options corresponding to the type of the document 
...
{\tt submission} & Anonymous submission with line numbers.\\
{\tt notanonymous} & Keep author names in submission mode when the
call for paper requires non-anonymous submissions.\\
{\tt final} & Final version.\\
\multicolumn{2}{c}{\textbf{Package options}}\\
...
\subsection{Macros which control the title page}
