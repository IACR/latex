...
\iffalse
\subsection{Converting \texttt{llncs} papers to \texttt{iacrcc} for submission}
...
\item Replace \verb+\documentclass{llncs}+ with\\
    \verb+\documentclass[version=submission]{iacrcc}+;
\item Replace \verb+\bibliographystyle{splncs03}+ with
  \verb+\bibliographystyle{iacrcc}+ or add
  \verb+\documentclass[biblatex]{iacrcc}+ to use the \texttt{biblatex}
  package. See also \autoref{sec:biblio} for information about how to
...
\paragraph{\texttt{\textbackslash license}}
