...
\title[running  = {The iacrcc class},
       subtitle = {iacrcc LaTeX Class Documentation (v0.57)}
...
\begin{center}
  \begin{tabular}{l@{\hspace{1cm}}p{0.7\linewidth}}
    ...
    {\tt text}    & The specific text used to acknowledge this funding. 
                    This text is inserted in a dedicated ``Funding Acknowledgements''
                    section just before the References.\\
    {\tt mode}    & The display mode of the ``Funding Acknowledgements'' section.
                    When omitted the regular Section style is used. 
                    Currently, the only option which can be used is ``EU'' to insert 
                    the official EU emblem per the
                    \href{https://rea.ec.europa.eu/communicating-about-your-eu-funded-project_en#acknowledge-eu-funding}{EU funding rules}.
  \end{tabular}
\end{center}
...
Note that \cmd{addfunding} collects the
metadata for indexing. When the \texttt{text} option is used then a dedicated
``Funding Acknowledgements'' section at the end of the paper before the References
with the provided text is created. When \texttt{mode=EU} is used then 
the official EU emblem is displayed. Note that you can omit using this \texttt{text}
option if you want to provide the funding information yourself using the 
\texttt{footnote} option on \cmd{addauthor}, or the \cmd{genericfootnote}, or add a separate
acknowledgements section. 

The following example funding text
\begin{verbatim}
\addfunding[country  = {europe},
            grantid  = {H2020-ICT-2014-1 644209},
            fundref  = {100010661},
            text     = {The research leading to these results has received 
                        funding from the European Union's Horizon 2020 
                        research and innovation programme with contract 
                        H2020-ICT-2014-1 644209 HEAT.},
            mode      = {EU}
           ]{Horizon 2020 Framework Programme}
\end{verbatim}
created the Section below at the end of the paper.
\section*{Funding Acknowledgements}
\noindent\begin{minipage}{\textwidth}
  \begin{minipage}{0.1\textwidth}
    {\fontsize{32}{0}\selectfont\euflag}
  \end{minipage}\hfill
  \begin{minipage}{0.87\textwidth}
    The research leading to these results has received funding
    from the European Union's Horizon 2020 research and innovation
    programme with contract H2020-ICT-2014-1 644209 HEAT.  \end{minipage}
\end{minipage}
