...
\subtitle{\LaTeX{} Class Documentation (v. 0.10)}
...
\affiliation{Self}
% Should we list Gaëtan Leurent and Friedrich Wiemer as authors as well?
...
\keywords[\publname, LaTeX]{\publname{} \and \LaTeX}
...
% ToDo: shorter list of author names.
...
the (list of) author(s) using {\tt \textbackslash{}author}.
