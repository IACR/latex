...
\title[running  = {The iacrcc class},
       subtitle = {iacrcc LaTeX Class Documentation (v0.37)}
...
provides a mechanism for loading packages before \texttt{hyperref}. If
the file \texttt{before-hyperref.sty} exists in the directory of your
main file, then it will be included before loading \texttt{hyperref}.
As an example, to load \texttt{longtable} before \texttt{hyperref}, you
can create a file \texttt{before-hyperref.sty} that contains:
\begin{verbatim}
